...
export function Path() {
    ...
    return (
        <div>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Parcours</h2>
            ...
            <div className="mt-5 sm:mt-10 flex flex-col gap-6">
                <div className="border border-purple-400 rounded-lg p-6 shadow-gray-950 shadow-xl relative">
                    ...
                    <div className="relative pl-12 mt-2">
                        ...
                        <div
                            ...
                            className="border-purple-400 lg:w-1/3 border rounded-lg p-3 sm:p-6 shadow-gray-950 shadow-lg hover:shadow-purple-100 hover:border-purple-700 hover:shadow-md transition-shadow duration-500 cursor-pointer"
                        >
                            <p className="text-md sm:text-lg font-semibold">2024 - Présent : Étudiant</p>
                            ...
                            <div className="absolute -mt-24 md:-mt-24 lg:-mt-24 ml-55 md:ml-118 lg:ml-113">
                    ...
                    {selectedPath === 'ynov' && (
                            <div className="lg:absolute mt-5 lg:-mt-35.5 ml-12 lg:ml-165 lg:w-6/11 border border-purple-500 rounded-lg p-6 z-10">
                                <h3 className="text-lg sm:text-2xl font-semibold text-purple-300 mb-3">Détails supplémentaires</h3>
                                <div className='absolute w-11 sm:w-15 aspect-square mt-71 sm:mt-54 lg:bottom-4 ml-47 sm:ml-113 lg:right-10'>
                                    <Image
                                        src="/ynov.jpg"
                                        alt="Ynov logo"
                                        fill
                    ...
                    <div className="relative pl-12 mt-6">
                        ...
                        >
                            ...
                            <div className="absolute -mt-43 md:-mt-37 lg:-mt-37 ml-55 md:ml-118 lg:ml-113">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-info-icon lucide-info"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                            </div>
                        </div>
                    </div>
                    ...
                    {selectedPath === 'bac' && (
                            <div className="lg:absolute mt-5 lg:-mt-90 ml-12 lg:ml-165 lg:w-6/11 border border-purple-500 rounded-lg p-6 z-10">
                                <h3 className="text-lg sm:text-2xl font-semibold text-purple-300 mb-3">Détails supplémentaires</h3>
                                 <div className='absolute w-11 sm:w-15 aspect-square mt-71 sm:mt-54 lg:bottom-4 ml-47 sm:ml-113 lg:right-10'>
                                    <Image
                                        src="/bb.jpg"

...
export function Path() {
    ...
    return (
        <div>
            <h2 id="path-heading" className="text-3xl md:text-5xl font-bold mb-6">Formations</h2>
            ...
            <div className="mt-5 sm:mt-10 flex flex-col gap-6 xl:w-4/9">
                <div className="border border-purple-400 rounded-lg p-6 shadow-gray-950 shadow-xl relative">
                    <div className="absolute ml-4 top-6 bottom-6 w-1 bg-purple-50 rounded-full" aria-hidden="true" />
                    ...
                    {selectedPath === 'ynov' && (
                        <div id='ynov-details' className="mt-5 ml-12 border border-purple-500 rounded-lg p-6 z-10">
                            <h3 className="text-lg sm:text-2xl font-semibold text-purple-300 mb-3">Détails supplémentaires</h3>
                            <p className="text-gray-300 text-sm sm:text-lg">
                                <strong>Ynov</strong> est une école d'informatique reconnue qui offre une formation axée sur les technologies modernes et les compétences pratiques.
                    ...
                    {selectedPath === 'bac' && (
                        <div id="bac-details" className="mt-5 ml-12 border border-purple-500 rounded-lg p-6 z-10">
                            <h3 className="text-lg sm:text-2xl font-semibold text-purple-300 mb-3">Détails supplémentaires</h3>
                            <p className="text-gray-300 text-sm sm:text-lg">
                                Le lycée <strong>Borde Basse</strong> est un lycée situé à Castres qui offre un enseignement général, technologique et professionnel.
            ...
            <div className="hidden xl:flex items-center justify-center absolute left-4/9 right-0 top-1/3 bottom-1/9" aria-hidden="true" >
